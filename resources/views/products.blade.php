...
<script>
    ...
    var database = firebase.firestore.database;

    var lastIndex = 0;

    // Get Data
    firebase.firestore.database().ref('Users/').on('value', function (snapshot) {
    ...
    $('#submitUser').on('click', function () {
        ...
        firebase.firestore.database().ref('Users/' + userID).set({
            name: name,
            email: email,
        });
    ...
    $('body').on('click', '.updateData', function () {
        ...
        firebase.firestore.database().ref('Users/' + updateID).on('value', function (snapshot) {
    ...
    $('.updateUser').on('click', function () {
        ...
        firebase.firestore.database().ref().update(updates);
    ...
    $('.deleteRecord').on(php'click', function () {
        var values = $(".users-remove-record-model").serializeArray();
        var id = values[0].value;
        firebase.firestore.database().ref('Users/' + id).remove();
